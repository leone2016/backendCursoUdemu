...
//                System.out.println("---ARTICULO "+articuloDTO.getCode());
                   ...
                   listFotoDTO.add(new FotosDTO(fotoArticulo.getUrl()+fotoArticulo.getNombreImagen()+fotoArticulo.getTipoImagen(),fotoArticulo.getArticulo().getCodigo()));
...
//            articuloDTO.setAgotado(this.isAgotado(articulo.));
